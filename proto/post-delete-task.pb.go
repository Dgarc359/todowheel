...
type PostDeleteTask struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TaskName string `protobuf:"bytes,1,opt,name=task_name,json=jsonName,proto3" json:"task_name,omitempty"`
}
...
func (x *PostDeleteTask) String() string {
